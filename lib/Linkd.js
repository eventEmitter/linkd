!function() {
	...
	var classDefinition = {
		...
		, init: function(CustomType) {
			...
			if (CustomType){
				if (!(CustomType instanceof Node)) throw new Error('The custom type must inherit from the LinkedList.Item class!');
		 ...
		 */
		, getFirst: function() {
			return this.firstNode ? this.get(this.firstNode.hash) : undefined;
		}
		 ...
		 */
		, getLast: function() {
			return this.lastNode ? this.get(this.lastNode.hash) : undefined;
		}
		...
		, getFirstNode: function() {
			return this.firstNode ? this.getNode(this.firstNode.hash) : null;
		}
		...
		, getLastNode: function() {
			return this.lastNode ? this.getNode(this.lastNode.hash) : null;
		}
